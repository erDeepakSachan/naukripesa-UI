        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header box-header well">
                    <h2 class="modal-title" id="model-title-h2"><i class="fa fa-plus"></i> Add New Company</h2>
                    <div class="box-icon">
...
export class AddComponent {
    ...
    onSubmit(form: NgForm): void {
      ...
      if (isValid) {
        this.obj.CompanyId = 0;
        this.obj.CurrencyId = 1;
        this.obj.Currency = null;
